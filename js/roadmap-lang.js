const roadmapTranslations = {
        ru: {
            ...
            step0_title: "MVP: текущий этап — что уже сделано",
            ...
            step0_item_6: "Раздел уведомлений: гарантия ≤30 дней или истекла",
            step0_item_7: "Загрузка фото/PDF чека, drag&drop, привязка к вещи",
            step0_item_8: "Бизнес: создание магазина, генерация Ed25519 ключей",
            step0_item_9: "Бизнес: выписка чека с несколькими позициями и цифровой подписью",
            step0_item_10: "Бизнес: PDF с QR-кодом, график продаж",
            step0_item_11: "Верификация: сканирование QR камерой, загрузка PDF, проверка Ed25519",
            step0_item_12: "Тёмная/светлая тема, мультиязычность RU/EN",
            step0_item_13: "Серверная верификация подписи: Edge Function с rate-лимитом по IP, анонимная страница проверки",
            step0_item_14: "Бизнес: выручка, средний чек, графики с периодами, фильтры, удаление чеков",
            step0_item_15: "Черновик чека: автосохранение формы и восстановление",
            step0_item_16: "Автоподстановка покупателя по email с историей клиентов",
            step0_item_17: "Бизнес: загрузка логотипов магазинов и отображение в PDF чеках",
            step0_item_18: "Экспорт календаря гарантий на устройство пользователя",
            ...
            step1_item_12: "Выбор валюты магазина и чека (мультивалютность, EUR по умолчанию)",
            step1_item_13: "Эстонский язык интерфейса (ET)",
            step1_item_14: "Подпись чека на сервере: приватный ключ хранится только в Edge Function (Vault), на устройство не передаётся",
            step1_item_15: "Импорт исторических чеков через CSV",
            step1_item_16: "Экспорт чеков для бухгалтерии (CSV/XML под 1С, DATEV)",
            ...
            step3_item_6: "Workflow возврата/обмена/аннулирования чека",
            step3_item_7: "Ротация и отзыв криптоключей магазина",
            step3_item_8: "Расширенная аналитика: LTV, средний чек, доля гарантийных обращений, % вернувшихся покупателей",
            step3_item_9: "Продажа расширенной гарантии в момент выписки чека (комиссия)",
            ...
            step4_item_4: "Онбординг-чеклист для нового магазина в дашборде",
        ...
        en: {
            ...
            step0_title: "MVP: current stage — what's already built",
            ...
            step0_item_6: "Notifications section: warranty ≤30 days or expired",
            step0_item_7: "Receipt photo/PDF upload, drag&drop, attachment to item",
            step0_item_8: "Business: store creation, Ed25519 key generation",
            step0_item_9: "Business: multi-item receipt issuance with digital signature",
            step0_item_10: "Business: PDF with QR code, sales chart",
            step0_item_11: "Verification: QR camera scan, PDF upload, Ed25519 check",
            step0_item_12: "Dark/light theme, RU/EN multilingual support",
            step0_item_13: "Server-side signature verification: Edge Function with per-IP rate limiting, anonymous verification page",
            step0_item_14: "Business: revenue, average receipt, period charts, filters, receipt deletion",
            step0_item_15: "Receipt draft: auto-save of the form and restore",
            step0_item_16: "Customer autocomplete by email with customer history",
            step0_item_17: "Business: shop logo upload and display in PDF receipts",
            step0_item_18: "Warranty calendar export to the user's device",
            ...
            step1_item_12: "Shop and receipt currency selection (multicurrency, EUR by default)",
            step1_item_13: "Estonian interface language (ET)",
            step1_item_14: "Server-side receipt signing: private key stored only in Edge Function (Vault), never sent to the user's device",
            step1_item_15: "Bulk historical receipt import via CSV",
            step1_item_16: "Receipt export for accounting (CSV/XML for 1C, DATEV, etc.)",
            ...
            step3_item_6: "Return/exchange/void workflow for issued receipts",
            step3_item_7: "Store key rotation and revocation",
            step3_item_8: "Advanced analytics: LTV, average order, warranty claim rate, % of returning customers",
            step3_item_9: "Extended warranty upsell at receipt issuance time (commission)",
            ...
            step4_item_4: "Onboarding checklist for new stores in the dashboard",
