...
const translations = {
    ru: {
        ...
        hero_badge: "🟢 Ранний доступ открыт",
        ...
        proc_2_title: "Верификация", proc_2_desc: "Система рассчитывает точную дату окончания гарантии и добавляет товар в ваш личный кабинет.",
    ...
    en: {
        ...
        proc_2_title: "Verification", proc_2_desc: "The system calculates the exact warranty expiry date and adds the item to your dashboard.",
